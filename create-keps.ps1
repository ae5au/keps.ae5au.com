...
$FMKeps = $FMKeps.replace("TEVEL2-2","Tevel2-1 FM 145.970 436.400")
$FMKeps = $FMKeps.replace("TEVEL2-3","Tevel2-1 FM 145.970 436.400")
$FMKeps = $FMKeps.replace("TEVEL2-4","Tevel2-1 FM 145.970 436.400")
$FMKeps = $FMKeps.replace("TEVEL2-5","Tevel2-1 FM 145.970 436.400")
$FMKeps = $FMKeps.replace("TEVEL2-6","Tevel2-1 FM 145.970 436.400")
$FMKeps = $FMKeps.replace("TEVEL2-7","Tevel2-1 FM 145.970 436.400")
$FMKeps = $FMKeps.replace("TEVEL2-8","Tevel2-1 FM 145.970 436.400")
